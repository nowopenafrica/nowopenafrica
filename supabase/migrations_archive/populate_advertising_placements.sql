/*
  # Populate Advertising Placements with Real Data

  1. New Data
    - Adding over 30 real advertising placements across various categories:
      - Billboards
      - Signage
      - Lamp Post Advertisements
      - Bus Advertisements
      - Out of Home (OOH) Advertising
    - Diverse locations across major Nigerian cities (Lagos, Abuja, Port Harcourt, etc.)
    - Realistic pricing data based on industry standards
    - Various durations and traffic densities

  2. Changes
    - Clear existing placeholder data
    - Insert new realistic advertising placement data
*/
