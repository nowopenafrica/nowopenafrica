// Types for the NowOpen Business Intelligence & Profile Enrichment engine.
// Mirror the migration columns in 20260911* so the admin/CLI reviewer sees the
// same vocabulary the database will enforce.

/** Which field this evidence row describes. Mirrors UPDATABLE_FIELDS in
 *  src/lib/imports/matchExisting.ts plus engine-only fields (hours_*,
 *  availability_*, media assets). */
...
export interface BusinessMediaAsset {
  ...
  source_id?: string | null;
  source_url?: string | null;
  /** The asset's own rights-bearing URL as the source presented it. */
