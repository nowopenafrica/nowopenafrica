            ...
            {plan.map((t) => {
              ...
              return (
                <button key={t.id} onClick={() => toggle(t.id)}
                  className={`w-full text-left flex items-start gap-3 px-3 rounded-xl border transition ${isDone ? 'border-green-200 dark:border-green-900 bg-green-50 dark:bg-green-950/40' : 'border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700'} min-h-[44px]`}>
                  {isDone
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <button onClick={() => onNavigate('assistant')}
              className="mt-3 inline-flex items-center gap-1.5 text-sm font-medium bg-white text-purple-700 px-3.5 rounded-lg hover:bg-purple-50 min-h-[44px]">
