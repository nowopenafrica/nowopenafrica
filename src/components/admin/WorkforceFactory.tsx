          ...
          <div className="flex items-center gap-2">
            {onOpenSection && (
              <button type="button" onClick={() => onOpenSection('workforce')}
                className="inline-flex items-center gap-1.5 px-3 rounded-lg text-xs font-semibold text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition min-h-[44px]">
                <ArrowRight size={13} /> Directory
              </button>
            )}
            {summary.open > 0 && (
              <button type="button" onClick={() => void fillAll()} disabled={busy}
                className="inline-flex items-center gap-1.5 px-3 rounded-lg text-xs font-semibold text-white bg-purple-600 hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition min-h-[44px]">
                    ...
                    {hiringKey === r.agentKey && (
                      <form
                        ...
                        <input
                          ...
                          className="flex-1 min-w-0 px-2.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-xs text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 min-h-[44px] items-center"
                        />
                        <button type="submit" disabled={busy}
                          className="inline-flex items-center gap-1.5 px-3 rounded-lg text-[10px] font-bold text-white bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 transition min-h-[44px]">
