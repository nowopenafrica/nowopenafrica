...
export default function BusinessClockCard({ business, businesses, onSelectBusiness }: BusinessClockCardProps) {
  ...
  const timeInputClass = 'w-20 rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-1.5 py-1 text-xs text-gray-900 dark:text-white disabled:opacity-40';
    ...
    <div className="rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-800 p-5">
      ...
      <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="rounded-lg border border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => handleClockIn(-1)} className="ml-auto w-7 h-7 rounded-md bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 text-sm hover:bg-gray-100 dark:hover:bg-gray-700">−</button>
            <button onClick={() => handleClockIn(1)} className="w-7 h-7 rounded-md bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 text-sm hover:bg-gray-100 dark:hover:bg-gray-700">+</button>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div className="rounded-lg border border-gray-100 dark:border-gray-700 p-3">
          ...
          <p className="mt-1 text-base font-bold text-gray-900 dark:text-white">{streak} days</p>
          <p className="text-[11px] text-gray-500 dark:text-gray-400">{streak > 0 ? 'Keep it going 🔥' : 'Open today to start'}</p>
        </div>
        <div className="rounded-lg border border-gray-100 dark:border-gray-700 p-3">
          <div className="flex items-center gap-1.5">
          ...
          <p className="mt-1 text-base font-bold text-gray-900 dark:text-white">{reliability}%</p>
        ...
        <div className="rounded-lg border border-gray-100 dark:border-gray-700 p-3">
          ...
          <p className="mt-1 text-base font-bold text-gray-900 dark:text-white">{health.score}% · {healthLabel(health.score)}</p>
      ...
      <button
        ...
        className="mt-4 inline-flex items-center gap-1 text-xs font-semibold text-purple-600 dark:text-purple-400"
      >
      ...
      <div className="mt-4 border-t border-gray-100 dark:border-gray-700 pt-4">
        <div className="flex items-center justify-between gap-2 flex-wrap">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-gradient-to-r from-purple-700 to-fuchsia-700 text-white hover:from-purple-800 hover:to-fuchsia-800 transition"
          >
        ...
        {showAssistant && (
          <div className="mt-3 space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              <button onClick={() => copy(pack.instagramCaption, 'Instagram caption')} className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium bg-pink-50 dark:bg-pink-900/20 text-pink-700 dark:text-pink-300 border border-pink-200 dark:border-pink-800 hover:bg-pink-100 dark:hover:bg-pink-900/40">
                <Instagram size={13} /> Instagram caption
              </button>
              <button onClick={() => copy(pack.whatsappStatus, 'WhatsApp status')} className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 border border-green-200 dark:border-green-800 hover:bg-green-100 dark:hover:bg-green-900/40">
                <MessageCircle size={13} /> WhatsApp status
              </button>
              <button onClick={() => copy(pack.xPost, 'X post')} className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-600 hover:bg-gray-200 dark:hover:bg-gray-600">
                <MessageCircle size={13} /> X post
              </button>
              <button onClick={() => copy(pack.sms, 'SMS')} className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800 hover:bg-blue-100 dark:hover:bg-blue-900/40">
                <Mail size={13} /> SMS
              </button>
              <button onClick={() => copy(pack.email, 'Email')} className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800 hover:bg-amber-100 dark:hover:bg-amber-900/40">
                <Mail size={13} /> Email
              </button>
              <button
                onClick={() => copy(`${campaign.title}\n${campaign.flyerHeadline}\n${campaign.posterHeadline}\n${campaign.storyIdea}\n${campaign.reelIdea}\n${campaign.caption}\n${campaign.hashtags.join(' ')}`, 'Opening campaign')}
                className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300 border border-purple-200 dark:border-purple-800 hover:bg-purple-100 dark:hover:bg-purple-900/40"
              >
