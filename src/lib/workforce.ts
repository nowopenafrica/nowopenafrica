...
export const AI_ROSTER_SEED: AiRosterSeed[] = [
  ...
  { name: 'Customer Success Manager', title: 'Customer Success Manager', department: 'Customer Success', agentKey: 'customer-success', currentWork: 'Onboards businesses and watches for drop-off; nudges owners before they churn.' },
  { name: 'Trust & Safety Agent', title: 'Trust & Safety Agent', department: 'Trust & Safety', agentKey: 'trust-safety', currentWork: 'Reviews verification and flags suspicious activity; enforcement escalates to a human.' },
