...
export const ADMIN_SECTIONS: AdminSection[] = [
  ...
  { id: 'ai-command', num: 29, group: 'Oversight', status: 'live', label: 'OpenAI Code Center', blurb: 'The internal AI operating layer powered by the OpenCode engine: ask anything about NowOpen in plain English and get real tool runs (directory, claims, analytics, quality, security) with an honest audit trail. Level 2 Prepare — read-only tools execute now; write tools are registered for the Phase 2 approval flow.', reuses: ['ai_sessions', 'ai_messages', 'ai_tool_calls', 'ai_approvals', 'ai_tasks'] },
  ...
  { id: 'approvals', num: 23, group: 'People', status: 'live', label: 'Approvals Hub', blurb: 'Agent-finished work queued for a human sign-off — approving closes the work item, rejecting sends it back, from os_approvals.', reuses: ['os_approvals', 'os_work_items', 'os_workforce'] },
  { id: 'workforce-factory', num: 24, group: 'People', status: 'live', label: 'Workforce Factory', blurb: 'Hire AI agents straight off their digital job descriptions — only genuinely open roles are offered, and reporting lines come from the real tree.', reuses: ['os_workforce', 'jobDescriptions', 'hierarchy'] },
  { id: 'onboarding', num: 25, group: 'People', status: 'live', label: 'Onboarding Command Center', blurb: 'The People OS front door: every NowOpen Relationship Profile — employees, partners, volunteers, creatives and investors — walked through its own onboarding journey with honest progress, signature tracking and doc packs from os_onboarding.', reuses: ['os_onboarding', 'relationships', 'onboardingProfiles', 'os_workforce'] },
  { id: 'document-center', num: 26, group: 'People', status: 'live', label: 'Document Centre', blurb: 'The agreement layer: reusable templates (NDA, partnership, volunteer, creative, employment...) drafted into real documents for a counterparty, with an honest draft → sent → signed → declined ledger on os_documents.', reuses: ['os_documents', 'documents', 'relationships'] },
  { id: 'signing-vault', num: 27, group: 'People', status: 'live', label: 'Signing Vault & Provisioning', blurb: 'The e-signature layer: a sent document is a signing request — capture the counterparty signature (manual or digital) on os_signatures, and once every required document for a relationship is signed, the profile access grants are provisioned.', reuses: ['os_signatures', 'os_documents', 'os_onboarding', 'documents', 'onboardingProfiles'] },
  { id: 'applications', num: 28, group: 'People', status: 'live', label: 'Applications Review', blurb: 'The front door of the Forms Hub: every os_form_applications submission reviewed and advanced through its own relationship pipeline, or rejected with an honest note — approved applicants continue in the Onboarding Command Center.', reuses: ['os_form_applications', 'formsEngine'] },
  ...
  { id: 'motion', num: 3, group: 'Create', status: 'live', label: 'Motion Studio', blurb: 'One editable project, three ways in — Quick Create starts from a format and a modern template, Studio is the full editor with a live canvas, and the AI Director writes the brief for you. Every mode ends in the same MotionProject you can resize, re-edit and render.', reuses: ['motionGraphics', 'motionTemplates', 'motionProject', 'renderVideo'] },
  ...
  { id: 'press-room', num: 10, group: 'Operate', status: 'live', label: 'Press Room', blurb: 'Press kit, founder bio, media photos, investor deck, download centre and the news timeline as a press-and-coverage ledger on os_press.', reuses: ['os_press'] },
  ...
  { id: 'media-intelligence', num: 30, group: 'Oversight', status: 'live', label: 'Media Intelligence & Moderation', blurb: 'The human half of the asset registry: discovery ships candidates, a person approves and publishes them, and a takedown honour is final.', reuses: ['business_media_assets', 'business_evidence'] },
  { id: 'change-proposals', num: 31, group: 'Oversight', status: 'live', label: 'Change Proposals & Evidence', blurb: 'Sourced changes the enrichment engine wants to make to a business — reviewed by a person and applied through the evidence-backed applier, or rejected to stay history.', reuses: ['business_change_proposals', 'business_evidence'] },
  { id: 'enrichment-ops', num: 32, group: 'Oversight', status: 'live', label: 'Enrichment Engine Ops', blurb: 'Diagnostics and control for the continuous-enrichment scheduler: cron status, the job queue, and the two admin levers — enqueue what is due now, and return failed jobs to the line.', reuses: ['business_enrichment_jobs', 'private_config'] },
];
