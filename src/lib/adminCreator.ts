...
export const ADMIN_SECTIONS: AdminSection[] = [
  ...
  { id: 'founder', num: 20, group: 'Oversight', status: 'live', label: 'Founder Dashboard', blurb: 'Private executive view: company health score, growth velocity, churn, strategic recommendations and the operating system across all six os_* ledgers.', reuses: ['os_workforce', 'os_work_items', 'os_approvals', 'os_knowledge', 'os_launches', 'os_partners'] },
