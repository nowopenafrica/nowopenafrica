...
export const SAMPLE_MEDICINES: SampleMedicine[] = [
  { id: 'med_1', name: 'Paracetamol 500mg', description: 'Fast relief from mild pain and fever.', price: '₦800', image: px(208541), stock: 120, med_category: 'Pain & Fever', requires_prescription: false, pack_size: 'Pack of 20 tablets' },
  { id: 'med_2', name: 'Ibuprofen 400mg', description: 'Anti-inflammatory for aches, pains and inflammation.', price: '₦1,500', image: px(3683074), stock: 80, med_category: 'Pain & Fever', requires_prescription: false, pack_size: 'Pack of 24 tablets' },
  ...
  { id: 'med_8', name: 'Antimalarial (ACT)', description: 'Artemisinin-based combination therapy for malaria.', price: '₦2,200', image: px(3683051), stock: 50, med_category: 'Malaria', requires_prescription: false, pack_size: 'Full adult course' },
];
