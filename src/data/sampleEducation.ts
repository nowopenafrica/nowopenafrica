...
export const SAMPLE_COURSES: SampleCourse[] = [
  ...
  { id: 'crs_3', name: 'Secondary School', description: 'JSS1–SS3 with WAEC & IGCSE prep.', price: '₦320,000 / term', image: px(8926648), service_category: 'Secondary', instructor: 'Mrs. Bello', class_schedule: 'Mon–Fri · 8AM–3:30PM', duration_min: null, is_online: false },
