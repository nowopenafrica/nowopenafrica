...
export const SAMPLE_FITNESS: SampleFitnessItem[] = [
  ...
  { id: 'cls_2', name: 'HIIT Blast', description: 'Fat-burning high-intensity interval training.', price: '₦4,000 / class', image: px(28080), amenities: '', session_kind: 'class', class_level: 'Intermediate', class_schedule: 'Tue, Thu · 6:30 PM', instructor: 'Coach Emeka', duration_min: 40 },
