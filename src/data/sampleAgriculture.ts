...
export const SAMPLE_PRODUCE: SampleProduce[] = [
  { id: 'agr_1', name: 'Paddy Rice', description: 'Locally grown paddy rice, sold per 50kg bag.', price: '₦45,000', image: px(1537169), stock: 200, product_category: 'Grains', unit: 'per bag', is_featured: true },
  ...
  { id: 'agr_6', name: 'Palm Oil (25L)', description: 'Pure red palm oil, 25-litre keg.', price: '₦48,000', image: px(33783), stock: 80, product_category: 'Processed', unit: 'per keg', is_featured: false },
