...
export const SAMPLE_FASHION: SampleFashionItem[] = [
  ...
  { id: 'fsn_5', name: 'Kids Ankara Set', description: 'Adorable matching top and shorts for kids.', price: '₦12,000', image: px(5560516), stock: 20, fashion_category: 'Kids', sizes: '2-3y,4-5y,6-7y', fabric: 'Ankara cotton', is_featured: false },
